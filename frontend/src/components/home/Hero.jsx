      ...
      >
        ...
        >
          <button
            ...
            className="btn-gold text-sm px-8 py-4 flex items-center gap-2"
          >
        ...
        >
          ...
          >
            <div>
              <label className="form-label" style={{ color: '#F4742B' }}>Destination</label>
            ...
            <div>
              <label className="form-label" style={{ color: '#F4742B' }}>Experience</label>
              <select
                value={search.category}
                onChange={(e) => setSearch({ ...search, category: e.target.value })}
                className="input-field"
                style={{ background: 'rgba(22,18,16,0.95)' }}
              >
            ...
            <div>
              <label className="form-label" style={{ color: '#F4742B' }}>Travel Date</label>
              <div className="relative">
            ...
            <div>
              <label className="form-label" style={{ color: '#F4742B' }}>Guests</label>
              <div className="relative">
                <FiUsers className="absolute left-3 top-1/2 -translate-y-1/2 pointer-events-none" style={{ color: '#7A6148' }} size={14} />
                <input
                  type="number"
                  min={1} max={20}
                  value={search.guests}
            ...
            <button type="submit" className="btn-gold h-[52px] px-7 text-sm">
              Search
            </button>
          </form>
        </motion.div>
